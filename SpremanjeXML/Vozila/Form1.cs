...
namespace Vozila
{
    public partial class Form1 : Form
    {
        ...
        private void btnDodaj_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Unesi ispravne podatke za vozilo!", "Greška", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        private void SpremiUXml()
        {
            ...
            try
            {
                ...
                MessageBox.Show($"Podaci su uspijesno sačuvani u datoteku: {putanja}", "Informacija", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                MessageBox.Show("Odabrali ste fajl: " + filePath);
            }
        }
